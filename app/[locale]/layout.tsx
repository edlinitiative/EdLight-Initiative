...
/** Prerender a static page per locale; middleware picks which one is served. */
...
export default async function RootLayout({
  ...
  // Tells next-intl which catalogue to use while rendering statically — without
  // it these pages fall back to per-request rendering.
  setRequestLocale(isLocale(routeLocale) ? routeLocale : DEFAULT_LOCALE)
